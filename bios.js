 ...
 */
 ...
 try{
	deviceready.push(function(){
		...
		* @description Varre um array e executa methodo especificado
		*/
		Array.prototype.execute = function(method){
			...
			for(var i = 0; i < this.length; i++){
				...
				if(m && typeof m == 'string'){
					var m = o[method] || function(){};
				}
				
				results.push(m.apply(o, args));
			}
